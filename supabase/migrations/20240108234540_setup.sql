...
AS $$
DECLARE
  project_url TEXT := 'https://rhxdnddonhuygcrzqvkg.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJoeGRuZGRvbmh1eWdjcnpxdmtnIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxNTM0Mjc0NSwiZXhwIjoyMDMwOTE4NzQ1fQ.pPvdd6zB8svBbKqZmLhURHrdx5yVEVimPcVmFeSaDus'; -- full access needed for http request to storage
